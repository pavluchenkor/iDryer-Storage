...
![门户「集成」区块中的 Home Assistant 窗口](../../img/storage-ha-portal-integration.png)
...
![MQTT 集成页面上的 iDryer 设备](../../img/storage-ha-mqtt-devices.png)
...
![粘贴了布局的 Raw configuration editor](../../img/storage-ha-raw-editor.png)
*仪表板配置编辑器中的同一布局。*
