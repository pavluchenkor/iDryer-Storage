...
Шпаргалка по ручной отправке команд устройству через MQTT. Полный протокол idryer-core —
в [`lib/idryer-core/contracts/mqtt_contract.yaml`](../contracts/mqtt_contract.yaml).
