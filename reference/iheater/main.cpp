// ============================================================
// IHEATER ENTRYPOINT — НЕ для Storage Link.
// Storage Link стартует через src/storage/StorageMain.cpp.
// platformio.ini: build_src_filter исключает этот файл
// из esp32c3-storage-prod / esp32c3-storage-stage.
// ============================================================
