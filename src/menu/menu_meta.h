...
#define MENU_META_COUNT 55
#define MENU_LANG_COUNT 2
#define MENU_SERIALIZED_MAX_SIZE 5228
...
static const MenuMeta g_menu_meta[MENU_META_COUNT] = {
    ...
    { 26, { "Переливы", "Color cycle" }, { nullptr, nullptr },
      ...
      nullptr, nullptr },
    // [27] anim_swell
    { 27, { "Прилив", "Swell" }, { nullptr, nullptr },
      META_TOGGLE, 20, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [28] anim_ripple
    { 28, { "Рябь", "Ripple" }, { nullptr, nullptr },
      META_TOGGLE, 20, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [29] anim_spotlight
    { 29, { "Прожектор", "Spotlight" }, { nullptr, nullptr },
      META_TOGGLE, 20, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [30] anim_duo
    { 30, { "Два цвета", "Two tones" }, { nullptr, nullptr },
      META_TOGGLE, 20, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [31] idle_color_group
    { 31, { "ЦВЕТ", "COLOR" }, { nullptr, nullptr },
      META_SUBMENU, 18, 32, 8,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT,
      nullptr, nullptr },
    // [32] idle_red
    { 32, { "Красный", "Red" }, { nullptr, nullptr },
      META_TOGGLE, 31, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [33] idle_orange
    { 33, { "Оранжевый", "Orange" }, { nullptr, nullptr },
      META_TOGGLE, 31, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [34] idle_yellow
    { 34, { "Жёлтый", "Yellow" }, { nullptr, nullptr },
      META_TOGGLE, 31, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [35] idle_green
    { 35, { "Зелёный", "Green" }, { nullptr, nullptr },
      META_TOGGLE, 31, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [36] idle_cyan
    { 36, { "Голубой", "Cyan" }, { nullptr, nullptr },
      META_TOGGLE, 31, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [37] idle_blue
    { 37, { "Синий", "Blue" }, { nullptr, nullptr },
      META_TOGGLE, 31, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [38] idle_magenta
    { 38, { "Фиолетовый", "Magenta" }, { nullptr, nullptr },
      META_TOGGLE, 31, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [39] idle_white
    { 39, { "Белый", "White" }, { nullptr, nullptr },
      META_TOGGLE, 31, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [40] pulse_defaults
    { 40, { "ИМПУЛЬС", "PULSE DEFAULTS" }, { nullptr, nullptr },
      META_SUBMENU, 0, 41, 2,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT,
      nullptr, nullptr },
    // [41] pulse_color_group
    { 41, { "ЦВЕТ", "COLOR" }, { nullptr, nullptr },
      META_SUBMENU, 40, 42, 8,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT,
      nullptr, nullptr },
    // [42] pulse_red
    { 42, { "Красный", "Red" }, { nullptr, nullptr },
      META_TOGGLE, 41, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [43] pulse_orange
    { 43, { "Оранжевый", "Orange" }, { nullptr, nullptr },
      META_TOGGLE, 41, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [44] pulse_yellow
    { 44, { "Жёлтый", "Yellow" }, { nullptr, nullptr },
      META_TOGGLE, 41, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [45] pulse_green
    { 45, { "Зелёный", "Green" }, { nullptr, nullptr },
      META_TOGGLE, 41, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [46] pulse_cyan
    { 46, { "Голубой", "Cyan" }, { nullptr, nullptr },
      META_TOGGLE, 41, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [47] pulse_blue
    { 47, { "Синий", "Blue" }, { nullptr, nullptr },
      META_TOGGLE, 41, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [48] pulse_magenta
    { 48, { "Фиолетовый", "Magenta" }, { nullptr, nullptr },
      META_TOGGLE, 41, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [49] pulse_white
    { 49, { "Белый", "White" }, { nullptr, nullptr },
      META_TOGGLE, 41, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [50] pulse_duration
    { 50, { "ДЛИТЕЛЬНОСТЬ", "DURATION" }, { "сек", "sec" },
      META_VALUE, 40, -1, 0,
      META_VT_U16, 1.0f, 600.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [51] led_pulse
    { 51, { "ИМПУЛЬС", "LED PULSE" }, { nullptr, nullptr },
      META_ACTION, 0, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT,
      "led.pulse", "LedPulse" },
    // [52] ignore_external_cmd
    { 52, { "ИГНОР. ВНЕШ. КОМАНД", "IGNOR EXT CMD" }, { nullptr, nullptr },
      META_TOGGLE, 0, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL,
      "system.ignore_external_cmd", nullptr },
    // [53] units_count
    { 53, { "КОЛ-ВО ЮНИТОВ", "UNITS" }, { nullptr, nullptr },
      META_VALUE, 0, -1, 0,
      META_VT_U8, 1.0f, 1.0f, 1.0f, META_SCOPE_GLOBAL,
      nullptr, nullptr },
    // [54] language
    { 54, { "ЯЗЫК", "LANGUAGE" }, { nullptr, nullptr },
      META_VALUE, 0, -1, 0,
